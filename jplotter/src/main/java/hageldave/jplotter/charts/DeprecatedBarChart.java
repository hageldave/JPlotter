...
import hageldave.jplotter.renderers.DeprecatedBarRenderer;
...
public class DeprecatedBarChart {
    ...
    protected DeprecatedBarRenderer barRenderer;
    ...
    public DeprecatedBarChart(final boolean useOpenGL) {
        this(useOpenGL ? new BlankCanvas() : new BlankCanvasFallback(), AlignmentConstants.HORIZONTAL, "X", "Y");
    }

    public DeprecatedBarChart(final boolean useOpenGL, final int chartAlignment) {
        this(useOpenGL ? new BlankCanvas() : new BlankCanvasFallback(), chartAlignment, "X", "Y");
    }

    public DeprecatedBarChart(final JPlotterCanvas canvas, final int chartAlignment, final String xLabel, final String yLabel) {
        this.canvas = canvas;
        this.canvas.asComponent().setPreferredSize(new Dimension(400, 400));
        this.canvas.asComponent().setBackground(Color.WHITE);
        this.barRenderer = new DeprecatedBarRenderer(chartAlignment);
    ...
    public DeprecatedBarChart renderBars() {
    ...
    public DeprecatedBarChart setBarContentBoundaries() {
    ...
    protected DeprecatedBarChart reconstructBars(AtomicInteger index, BarStruct struct) {
    ...
    protected DeprecatedBarChart clearRenderedTriangles() {
    ...
    public DeprecatedBarRenderer getBarRenderer() {
        return barRenderer;
    }
