package hageldave.jplotter.hax;
 ...
 * Only {@link Graphics2D#clearRect(int, int, int, int)} does
 * not delegate in order to prevent clearing of GL renderings.
 * 
 * @author hageldave
...
public class NonClearGraphics2D extends Graphics2D {
	...
	/**
	 * Does nothing. This is to prevent a clearRect call from destroying a
	 * rendered image that was created before by an {@link FBOCanvas}.
	 */
