 ...
 * The ID of the DebugSetter is used to couple it with the corresponding DebugGetter (has to have the same ID).
...
public @interface DebugSetter {
    /**
     * @return the (unique) identifier of the setter method (used to connect it with a corresponding {@link DebugGetter}, needs the same ID for that)
     */
    String ID();
