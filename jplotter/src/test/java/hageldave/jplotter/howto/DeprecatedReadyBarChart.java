...
import hageldave.jplotter.charts.DeprecatedBarChart;
...
public class DeprecatedReadyBarChart {
    ...
    public static void main(String[] args) {
        ...
        DeprecatedBarChart barChart = new DeprecatedBarChart(false, AlignmentConstants.HORIZONTAL);

        DeprecatedBarChart.BarGroup group1 = barChart.createGroup(1);
        DeprecatedBarChart.BarGroup group2 = barChart.createGroup(2);
        ...
        DeprecatedBarChart.BarStruct barStruct = group1.getBarsInGroup().get(9);
